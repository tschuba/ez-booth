...
public class ModelMocks {
  ...
  public MockedStatic<ProtoMapper> mapper() {
    ...
    protoMapperMockedStatic
        .when(() -> ProtoMapper.messageToObject(messages.booth))
        .thenReturn(objects.booth);
    protoMapperMockedStatic
        .when(() -> ProtoMapper.messageToObject(messages.boothKey))
        .thenReturn(objects.boothKey);
    protoMapperMockedStatic
        .when(() -> ProtoMapper.objectToMessage(objects.booth))
        .thenReturn(messages.booth);
    protoMapperMockedStatic
        .when(() -> ProtoMapper.objectToMessage(objects.boothKey))
        .thenReturn(messages.boothKey);
