...
public class ProtoMapper {
    ...
    public static final Mappable<DataModel.Booth.Key, ProtoModel.BoothKey> BOOTH_KEY =
            new Mappable<>() {
                ...
                public Function<DataModel.Booth.Key, ProtoModel.BoothKey> objectToMessage() {
                    return key ->
                            ProtoModel.BoothKey.newBuilder().setBoothId(key.boothId()).build();
                }
    ...
    public static final Mappable<DataModel.Purchase.Key, ProtoModel.PurchaseKey> PURCHASE_KEY =
            new Mappable<>() {
                ...
                public Function<DataModel.Purchase.Key, ProtoModel.PurchaseKey> objectToMessage() {
                    return key -> {
                        ProtoModel.PurchaseKey.Builder builder =
            ...
            new Mappable<>() {
                ...
                public Function<DataModel.Purchase, ProtoModel.Purchase> objectToMessage() {
                    return purchase -> {
                        ...
                        if (purchase.key() != null) {
                            ProtoModel.PurchaseKey purchaseKey =
                                    PURCHASE_KEY.objectToMessage(purchase.key());
                ...
                public Function<ProtoModel.Purchase, DataModel.Purchase> messageToObject() {
                    return purchase -> {
                        ...
                        if (purchase.hasKey()) {
                            DataModel.Purchase.Key key =
                                    PURCHASE_KEY.messageToObject(purchase.getKey());
                            builder.key(key);
                        }
                        if (purchase.hasPurchasedOn()) {
                            LocalDateTime purchasedOn =
                                    DateAndTime.asDateTime(purchase.getPurchasedOn());
    ...
    public static final Mappable<DataModel.PurchaseItem, ProtoModel.PurchaseItem> PURCHASE_ITEM =
            new Mappable<>() {
                ...
                public Function<DataModel.PurchaseItem, ProtoModel.PurchaseItem> objectToMessage() {
                    return item -> {
                        ProtoModel.PurchaseItem.Builder builder =
                ...
                public Function<ProtoModel.PurchaseItem, DataModel.PurchaseItem> messageToObject() {
                    return item -> {
                        ...
                        DataModel.PurchaseItem.Key.KeyBuilder keyBuilder =
            ...
            new Mappable<>() {
                ...
                public Function<DataModel.Vendor, ProtoModel.Vendor> objectToMessage() {
                    return vendor -> {
                        ...
                        if (vendor.key() != null) {
                            ProtoModel.VendorKey vendorKey =
                                    VENDOR_KEY.objectToMessage(vendor.key());
    ...
    public static final Mappable<ServiceModel.Checkout, ProtoServices.CheckoutInput> CHECKOUT =
            new Mappable<>() {
                @Override
                @NonNull
                public Function<ServiceModel.Checkout, ProtoServices.CheckoutInput>
                        objectToMessage() {
                    return checkout -> {
                        ProtoServices.CheckoutInput.Builder builder =
                                ProtoServices.CheckoutInput.newBuilder();
                ...
                @Override
                @NonNull
                public Function<ProtoServices.CheckoutInput, ServiceModel.Checkout>
                        messageToObject() {
                    return checkout -> {
                        ServiceModel.Checkout.CheckoutBuilder builder =
    ...
    @NonNull
    public static ProtoServices.CheckoutInput objectToMessage(
            @NonNull ServiceModel.Checkout object) {
    ...
    public static final Mappable<ServiceModel.ChargedFees, ProtoServices.ChargedFees> CHARGED_FEES =
            new Mappable<>() {
                @Override
                @NonNull
                public Function<ServiceModel.ChargedFees, ProtoServices.ChargedFees>
                        objectToMessage() {
                    return fees -> {
                        ProtoServices.ChargedFees.Builder builder =
                                ProtoServices.ChargedFees.newBuilder();
                ...
                @Override
                @NonNull
                public Function<ProtoServices.ChargedFees, ServiceModel.ChargedFees>
                        messageToObject() {
                    return fees -> {
                    ...
                    new Mappable<>() {
                        ...
                        public Function<ProtoServices.ChargingConfig, ServiceModel.ChargingConfig>
                            ...
                            return config -> {
                                ...
                                builder.participationFee(
                                        BigDecimal.valueOf(config.getParticipationFee()));
                    ...
                    new Mappable<>() {
                        ...
                        public Function<ProtoServices.BalanceInput, ServiceModel.Balance.Input>
                            ...
                            return input -> {
                                ...
                                builder.totalSalesAmount(
                                        BigDecimal.valueOf(input.getTotalSalesAmount()));
                                if (input.hasChargingConfig()) {
                                    ServiceModel.ChargingConfig config =
                                            CHARGING_CONFIG.messageToObject(
                                                    input.getChargingConfig());
                    ...
                    new Mappable<>() {
                        ...
                        public Function<ServiceModel.Balance.Output, ProtoServices.SalesBalance>
                            ...
                            return output -> {
                                ...
                                ProtoServices.ChargedFees fees =
                                        CHARGED_FEES.objectToMessage(output.chargedFees());
                        ...
                        public Function<ProtoServices.SalesBalance, ServiceModel.Balance.Output>
                            ...
                            return output -> {
                                ...
                                if (output.hasFees()) {
                                    ServiceModel.ChargedFees fees =
                                            CHARGED_FEES.messageToObject(output.getFees());
    ...
    public static final Mappable<ServiceModel.VendorReportInput, ProtoServices.VendorReportInput>
            VENDOR_REPORT_INPUT =
                    new Mappable<>() {
                        ...
                        @NonNull
                        public Function<
                                        ServiceModel.VendorReportInput,
                                        ProtoServices.VendorReportInput>
                                objectToMessage() {
                            return input -> {
    ...
    public static final Mappable<ServiceModel.VendorReportData, ProtoServices.VendorReportData>
            VENDOR_REPORT_DATA =
                    new Mappable<>() {
                        ...
                        @NonNull
                        public Function<
                                        ServiceModel.VendorReportData,
                                        ProtoServices.VendorReportData>
                                objectToMessage() {
                            return reportData -> {
                                ProtoServices.VendorReportData.Builder builder =
                                        ProtoServices.VendorReportData.newBuilder();
                                ProtoModel.Vendor vendorMsg =
                                        VENDOR.objectToMessage(reportData.vendor());
                                builder.setVendor(vendorMsg);
                                ProtoModel.Booth boothMsg =
                                        BOOTH.objectToMessage(reportData.booth());
                                ...
                                builder.setParticipationFee(
                                        reportData.participationFee().floatValue());
                        ...
                        public Function<
                            ...
                            return reportData -> {
                                ...
                                if (reportData.hasVendor()) {
                                    DataModel.Vendor vendor =
                                            VENDOR.messageToObject(reportData.getVendor());
                                    builder.vendor(vendor);
                                }
                                if (reportData.hasBooth()) {
                                    DataModel.Booth booth =
                                            BOOTH.messageToObject(reportData.getBooth());
                                    builder.booth(booth);
                                }
                                List<DataModel.PurchaseItem> convertedItemsList =
                                        reportData.getItemsList().stream()
                                                .map(PURCHASE_ITEM::messageToObject)
                                                .toList();
                                builder.items(convertedItemsList);
                                builder.salesSum(Numbers.bigDecimalOf(reportData.getSalesSum()));
                                builder.participationFee(
                                        Numbers.bigDecimalOf(reportData.getParticipationFee()));
                                builder.salesFee(Numbers.bigDecimalOf(reportData.getSalesFee()));
                                builder.totalRevenue(
                                        Numbers.bigDecimalOf(reportData.getTotalRevenue()));
                                return builder.build();
                            };
                        }
                    };
    ...
    public static class DateAndTime {
        ...
        public static LocalDateTime asDateTime(@Nullable com.google.protobuf.Timestamp timestamp) {
            ...
            return LocalDateTime.ofEpochSecond(
                    timestamp.getSeconds(), timestamp.getNanos(), ZONE_OFFSET);
        }
