...
public class ProtoMapper {
   ...
   */
  public static final Mappable<DataModel.Booth.Key, ProtoModel.BoothKey> BOOTH_KEY =
      new Mappable<>() {
        @Override
        @NonNull
        public Function<DataModel.Booth.Key, ProtoModel.BoothKey> objectToMessage() {
          return key -> ProtoModel.BoothKey.newBuilder().setBoothId(key.boothId()).build();
        }

        @Override
        @NonNull
        public Function<ProtoModel.BoothKey, DataModel.Booth.Key> messageToObject() {
          return key -> DataModel.Booth.Key.builder().boothId(key.getBoothId()).build();
        }
      };
   ...
   */
  public static final Mappable<DataModel.Booth, ProtoModel.Booth> BOOTH =
      new Mappable<>() {
        @Override
        @NonNull
   ...
   */
  public static final Mappable<DataModel.Purchase.Key, ProtoModel.PurchaseKey> PURCHASE_KEY =
      new Mappable<>() {
        @Override
        @NonNull
   ...
   */
  public static final Mappable<DataModel.Purchase, ProtoModel.Purchase> PURCHASE =
      new Mappable<>() {
        @Override
        @NonNull
        ...
        public Function<ProtoModel.Purchase, DataModel.Purchase> messageToObject() {
          return purchase -> {
            ...
            builder.value(Numbers.bigDecimalOf(purchase.getValue()));

            List<DataModel.PurchaseItem> convertedItemsList =
                purchase.getItemsList().stream().map(PURCHASE_ITEM::messageToObject).toList();
   ...
   */
  public static final Mappable<DataModel.PurchaseItem, ProtoModel.PurchaseItem> PURCHASE_ITEM =
      new Mappable<>() {
        @Override
        @NonNull
        ...
        public Function<ProtoModel.PurchaseItem, DataModel.PurchaseItem> messageToObject() {
          return item -> {
            ...
            builder.price(Numbers.bigDecimalOf(item.getPrice()));
   ...
   */
  public static final Mappable<DataModel.Vendor.Key, ProtoModel.VendorKey> VENDOR_KEY =
      new Mappable<>() {
        @Override
        @NonNull
   ...
   */
  public static final Mappable<DataModel.Vendor, ProtoModel.Vendor> VENDOR =
      new Mappable<>() {
        @Override
        @NonNull
   ...
   */
  public static final Mappable<ServiceModel.Checkout, ProtoServices.CheckoutInput> CHECKOUT =
      new Mappable<>() {
        @Override
        @NonNull
        public Function<ServiceModel.Checkout, ProtoServices.CheckoutInput> objectToMessage() {
          return checkout -> {
            ...
            checkout.items().stream().map(ProtoMapper::objectToMessage).forEach(builder::addItems);
        ...
        public Function<ProtoServices.CheckoutInput, ServiceModel.Checkout> messageToObject() {
          return checkout -> {
            ...
            if (checkout.hasBooth()) {
              DataModel.Booth.Key boothKey = ProtoMapper.messageToObject(checkout.getBooth());
              builder.booth(boothKey);
            }
            List<ServiceModel.CheckoutItem> convertedItemsList =
                checkout.getItemsList().stream().map(ProtoMapper::messageToObject).toList();
            builder.items(convertedItemsList);
  ...
  public static final Mappable<ServiceModel.CheckoutItem, ProtoServices.CheckoutItem>
      CHECKOUT_ITEM =
          new Mappable<>() {
            @Override
            public @NonNull Function<ServiceModel.CheckoutItem, ProtoServices.CheckoutItem>
                objectToMessage() {
              return item ->
                  ProtoServices.CheckoutItem.newBuilder()
                      .setVendor(ProtoMapper.objectToMessage(item.vendor()))
                      .setPrice(item.price().floatValue())
                      .setPurchasedOn(DateAndTime.timestampOf(item.purchasedOn()))
                      .build();
            }

            @Override
            public @NonNull Function<ProtoServices.CheckoutItem, ServiceModel.CheckoutItem>
                messageToObject() {
              return item ->
                  ServiceModel.CheckoutItem.builder()
                      .vendor(ProtoMapper.messageToObject(item.getVendor()))
                      .price(BigDecimal.valueOf(item.getPrice()))
                      .purchasedOn(DateAndTime.asDateTime(item.getPurchasedOn()))
                      .build();
            }
          };
   ...
   */
  public static final Mappable<ServiceModel.ChargedFees, ProtoServices.ChargedFees> CHARGED_FEES =
      new Mappable<>() {
        @Override
        @NonNull
        ...
        public Function<ProtoServices.ChargedFees, ServiceModel.ChargedFees> messageToObject() {
          return fees -> {
            ServiceModel.ChargedFees.ChargedFeesBuilder builder =
                ServiceModel.ChargedFees.builder();
  ...
  @NonNull
  public static ProtoServices.ChargedFees objectToMessage(
      @NonNull ServiceModel.ChargedFees object) {
    return CHARGED_FEES.objectToMessage(object);
  }

  @NonNull
  public static ServiceModel.ChargedFees messageToObject(
      @NonNull ProtoServices.ChargedFees message) {
   ...
   */
  public static final Mappable<ServiceModel.ChargingConfig, ProtoServices.ChargingConfig>
      CHARGING_CONFIG =
          new Mappable<>() {
            @Override
            @NonNull
            public Function<ServiceModel.ChargingConfig, ProtoServices.ChargingConfig>
                objectToMessage() {
              return config -> {
                ProtoServices.ChargingConfig.Builder builder =
                    ProtoServices.ChargingConfig.newBuilder();
            ...
            @Override
            @NonNull
            public Function<ProtoServices.ChargingConfig, ServiceModel.ChargingConfig>
                messageToObject() {
              return config -> {
                ServiceModel.ChargingConfig.ChargingConfigBuilder builder =
  ...
  @NonNull
  public static ProtoServices.ChargingConfig objectToMessage(
      @NonNull ServiceModel.ChargingConfig object) {
    return CHARGING_CONFIG.objectToMessage(object);
  }

  @NonNull
  public static ServiceModel.ChargingConfig messageToObject(
      @NonNull ProtoServices.ChargingConfig message) {
   ...
   */
  public static final Mappable<ServiceModel.Balance.Input, ProtoServices.BalanceInput>
      BALANCE_INPUT =
          new Mappable<>() {
            @Override
            @NonNull
            public Function<ServiceModel.Balance.Input, ProtoServices.BalanceInput>
                objectToMessage() {
              return input -> {
                ProtoServices.BalanceInput.Builder builder =
                    ProtoServices.BalanceInput.newBuilder();
                builder.setTotalSalesAmount(input.totalSalesAmount().floatValue());
                ProtoServices.ChargingConfig config =
                    CHARGING_CONFIG.objectToMessage(input.chargingConfig());
            ...
            @Override
            @NonNull
            public Function<ProtoServices.BalanceInput, ServiceModel.Balance.Input>
                messageToObject() {
              return input -> {
                ServiceModel.Balance.Input.InputBuilder builder =
                ...
                if (input.hasChargingConfig()) {
                  ServiceModel.ChargingConfig config =
                      CHARGING_CONFIG.messageToObject(input.getChargingConfig());
  ...
  @NonNull
  public static ProtoServices.BalanceInput objectToMessage(
      @NonNull ServiceModel.Balance.Input object) {
    return BALANCE_INPUT.objectToMessage(object);
  }

  @NonNull
  public static ServiceModel.Balance.Input messageToObject(
      @NonNull ProtoServices.BalanceInput message) {
   ...
   */
  public static final Mappable<ServiceModel.Balance.Output, ProtoServices.SalesBalance>
      BALANCE_OUTPUT =
          new Mappable<>() {
            @Override
            @NonNull
            public Function<ServiceModel.Balance.Output, ProtoServices.SalesBalance>
                objectToMessage() {
              return output -> {
                ProtoServices.SalesBalance.Builder builder =
                    ProtoServices.SalesBalance.newBuilder();
            ...
            @Override
            @NonNull
            public Function<ProtoServices.SalesBalance, ServiceModel.Balance.Output>
                messageToObject() {
              return output -> {
                ServiceModel.Balance.Output.OutputBuilder builder =
                    ServiceModel.Balance.Output.builder();
  ...
  @NonNull
  public static ProtoServices.SalesBalance objectToMessage(
      @NonNull ServiceModel.Balance.Output object) {
    return BALANCE_OUTPUT.objectToMessage(object);
  }

  @NonNull
  public static ServiceModel.Balance.Output messageToObject(
      @NonNull ProtoServices.SalesBalance message) {
   ...
   */
  public static final Mappable<ServiceModel.VendorReportInput, ProtoServices.VendorReportInput>
      VENDOR_REPORT_INPUT =
          new Mappable<>() {
            @Override
            @NonNull
            public Function<ServiceModel.VendorReportInput, ProtoServices.VendorReportInput>
                objectToMessage() {
              return input -> {
                ProtoServices.VendorReportInput.Builder builder =
                    ProtoServices.VendorReportInput.newBuilder();
                if (input.vendors() != null) {
                  Arrays.stream(input.vendors())
                      .map(VENDOR_KEY::objectToMessage)
                      .forEach(builder::addVendor);
                }
                return builder.build();
              };
            }
            ...
            @Override
            @NonNull
            public Function<ProtoServices.VendorReportInput, ServiceModel.VendorReportInput>
                messageToObject() {
              return input -> {
                ServiceModel.VendorReportInput.VendorReportInputBuilder builder =
                    ServiceModel.VendorReportInput.builder();
                DataModel.Vendor.Key[] convertedVendors =
                    input.getVendorList().stream()
                        .map(VENDOR_KEY::messageToObject)
  ...
  @NonNull
  public static ProtoServices.VendorReportInput objectToMessage(
      @NonNull ServiceModel.VendorReportInput object) {
    return VENDOR_REPORT_INPUT.objectToMessage(object);
  }

  @NonNull
  public static ServiceModel.VendorReportInput messageToObject(
      @NonNull ProtoServices.VendorReportInput message) {
   ...
   */
  public static final Mappable<ServiceModel.VendorReportData, ProtoServices.VendorReportData>
      VENDOR_REPORT_DATA =
          new Mappable<>() {
            @Override
            @NonNull
            public Function<ServiceModel.VendorReportData, ProtoServices.VendorReportData>
                objectToMessage() {
              return reportData -> {
                ProtoServices.VendorReportData.Builder builder =
                    ProtoServices.VendorReportData.newBuilder();
                ...
                List<ProtoModel.PurchaseItem> itemsMsg =
                    reportData.items().stream().map(PURCHASE_ITEM::objectToMessage).toList();
                builder.addAllItems(itemsMsg);
                builder.setSalesSum(reportData.salesSum().floatValue());
                builder.setParticipationFee(reportData.participationFee().floatValue());
                builder.setSalesFee(reportData.salesFee().floatValue());
                builder.setTotalRevenue(reportData.totalRevenue().floatValue());
                return builder.build();
              };
            }
            ...
            @Override
            @NonNull
            public Function<ProtoServices.VendorReportData, ServiceModel.VendorReportData>
                messageToObject() {
              return reportData -> {
                ServiceModel.VendorReportData.VendorReportDataBuilder builder =
                    ServiceModel.VendorReportData.builder();
                ...
                List<DataModel.PurchaseItem> convertedItemsList =
                    reportData.getItemsList().stream().map(PURCHASE_ITEM::messageToObject).toList();
                builder.items(convertedItemsList);
                builder.salesSum(Numbers.bigDecimalOf(reportData.getSalesSum()));
                builder.participationFee(Numbers.bigDecimalOf(reportData.getParticipationFee()));
                builder.salesFee(Numbers.bigDecimalOf(reportData.getSalesFee()));
                builder.totalRevenue(Numbers.bigDecimalOf(reportData.getTotalRevenue()));
                return builder.build();
              };
            }
          };
  ...
  @NonNull
  public static ProtoServices.VendorReportData objectToMessage(
      @NonNull ServiceModel.VendorReportData object) {
    return VENDOR_REPORT_DATA.objectToMessage(object);
  }

  @NonNull
  public static ServiceModel.VendorReportData messageToObject(
      @NonNull ProtoServices.VendorReportData message) {
   ...
   */
  public static final Mappable<URI, ProtoCore.URI> URI =
      new Mappable<>() {
        @Override
        @NonNull
  ...
  public static Mappable<ServiceModel.ExchangeData, ProtoServices.ExchangeData> EXCHANGE_DATA =
      new Mappable<>() {
        @Override
        @NonNull
        public Function<ServiceModel.ExchangeData, ProtoServices.ExchangeData> objectToMessage() {
          return exchangeData -> {
            ProtoServices.ExchangeData.Builder builder = ProtoServices.ExchangeData.newBuilder();
            ProtoModel.Booth boothMsg = ProtoMapper.objectToMessage(exchangeData.booth());
            builder.setBooth(boothMsg);
        ...
        @Override
        @NonNull
        public Function<ProtoServices.ExchangeData, ServiceModel.ExchangeData> messageToObject() {
          return exchangeData -> {
            ServiceModel.ExchangeData.ExchangeDataBuilder builder =
                ServiceModel.ExchangeData.builder();
            if (exchangeData.hasBooth()) {
              DataModel.Booth booth = ProtoMapper.messageToObject(exchangeData.getBooth());
              builder.booth(booth);
            }

            List<DataModel.Vendor> vendors =
                exchangeData.getVendorsList().stream().map(ProtoMapper::messageToObject).toList();
            builder.vendors(vendors);

            List<DataModel.Purchase> convertedPurchasesList =
                exchangeData.getPurchasesList().stream().map(ProtoMapper::messageToObject).toList();
  ...
  public static final Mappable<ServiceModel.ExchangeReceiver, ProtoServices.ExchangeReceiver>
      EXCHANGE_RECEIVER =
          new Mappable<>() {
            @Override
            @NonNull
            public Function<ServiceModel.ExchangeReceiver, ProtoServices.ExchangeReceiver>
                objectToMessage() {
              return receiver ->
            ...
            @Override
            @NonNull
            public Function<ProtoServices.ExchangeReceiver, ServiceModel.ExchangeReceiver>
                messageToObject() {
              return receiver ->
  ...
  public static final Mappable<
      ...
      EXCHANGE_SUBSCRIPTION =
          new Mappable<>() {
            @Override
            @NonNull
            public Function<ServiceModel.ExchangeSubscription, ProtoServices.ExchangeSubscription>
                objectToMessage() {
              return subscription ->
                  ProtoServices.ExchangeSubscription.newBuilder()
                      .setId(subscription.id())
                      .setBooth(BOOTH_KEY.objectToMessage(subscription.booth()))
                      .build();
            }

            @Override
            @NonNull
            public Function<ProtoServices.ExchangeSubscription, ServiceModel.ExchangeSubscription>
                messageToObject() {
              return subscription ->
                  ServiceModel.ExchangeSubscription.builder()
                      .id(subscription.getId())
                      .booth(BOOTH_KEY.messageToObject(subscription.getBooth()))
                      .build();
            }
          };
  ...
  public static class DateAndTime {
    ...
    public static ProtoCore.Date dateOf(@Nullable LocalDate date) {
      ...
      return ProtoCore.Date.newBuilder()
  ...
  /**
   * Provides mapping between {@link BigDecimal} and float values.
   */
  public static class Numbers {
     ...
     * @return the BigDecimal representation of the given float value
     */
    public static BigDecimal bigDecimalOf(float value) {
