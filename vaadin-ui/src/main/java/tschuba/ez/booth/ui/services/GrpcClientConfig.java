...
public class GrpcClientConfig {
  ...
  @Bean
  PurchaseServiceGrpc.PurchaseServiceBlockingStub purchaseServiceStub(GrpcChannelFactory channels) {
  ...
  @Bean
  ChargingServiceGrpc.ChargingServiceBlockingStub chargingServiceStub(GrpcChannelFactory channels) {
