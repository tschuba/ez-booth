...
public class PurchaseSummary extends Div {
  ...
  public PurchaseSummary(
      @NonNull CheckoutConfirmationDialog confirmationDialog, @NonNull CheckoutConfig config) {
    this.config = config;
    ...
    vendorContainer.addClassNames(
        Display.BLOCK, Margin.Top.MEDIUM, Padding.NONE, Border.BOTTOM, BorderColor.CONTRAST_10);
