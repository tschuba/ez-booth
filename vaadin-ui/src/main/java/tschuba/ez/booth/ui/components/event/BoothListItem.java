  ...
  public BoothListItem(DataModel.Booth booth) {
    ...
    if (equalsCurrentEvent) {
      ...
      selectButton.addClickListener(
          clickEvent -> fireEvent(new SelectionEvent(this, clickEvent.isFromClient(), booth)));
    ...
    closeButton.addClickListener(
        enableAfterClick(
            clickEvent -> fireEvent(new CloseEvent(this, clickEvent.isFromClient(), booth))));
    ...
    reopenButton.addClickListener(
        enableAfterClick(
            clickEvent -> fireEvent(new ReopenEvent(this, clickEvent.isFromClient(), booth))));
    ...
    deleteButton.addConfirmationListener(
        confirmEvent -> fireEvent(new DeleteEvent(this, confirmEvent.isFromClient(), booth)));
