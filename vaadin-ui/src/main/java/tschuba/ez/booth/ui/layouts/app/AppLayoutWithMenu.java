...
public class AppLayoutWithMenu extends CustomAppLayout {
    public AppLayoutWithMenu(@Autowired BoothRepository booths) {
        super(
                ...
                List.of(
                        MainMenuItem.create(
                                new I18NTextKey(TranslationKeys.EventSelectionView.MENU_ITEM__TEXT),
                                STORE_SOLID.create(),
                                BoothSelectionView.class),
                        MainMenuItem.create(
                                new I18NTextKey(TranslationKeys.CheckoutView.MENU_ITEM__TEXT),
                                CASH_REGISTER_SOLID.create(),
                                CheckoutView.class),
                        MainMenuItem.create(
                                new I18NTextKey(TranslationKeys.VendorReportView.MENU_ITEM__TEXT),
                                COINS_SOLID.create(),
                                VendorReportView.class),
                        MainMenuItem.create(
                                new I18NTextKey(TranslationKeys.InfoView.MENU_ITEM__TEXT),
                                INFO_SOLID.create(),
                                InfoView.class)));
    }
}
