...
public class MainMenuItem extends Tab {
  ...
  public static final Supplier<MainMenuItem> BOOTH_SELECTION_VIEW = () -> MainMenuItem.create(
      I18N.textKey(TranslationKeys.BoothSelectionView.MENU_ITEM__TEXT),
      STORE_SOLID.create(),
      BoothSelectionView .class);
  public static final Supplier<MainMenuItem> CHECKOUT_VIEW = () -> MainMenuItem.create(
      I18N.textKey(TranslationKeys.CheckoutView.MENU_ITEM__TEXT),
      CASH_REGISTER_SOLID.create(),
      CheckoutView .class);
  public static final Supplier<MainMenuItem> VENDOR_REPORT_VIEW = () -> MainMenuItem.create(
      I18N.textKey(TranslationKeys.VendorReportView.MENU_ITEM__TEXT),
      COINS_SOLID.create(),
      VendorReportView .class);
  public static final Supplier<MainMenuItem> DATA_EXCHANGE_VIEW = () -> MainMenuItem.create(
