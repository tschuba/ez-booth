...
import tschuba.ez.booth.ui.components.SectionTitle;
import tschuba.ez.booth.ui.components.event.EventRequired;
import tschuba.ez.booth.ui.components.event.EventSelection;
import tschuba.ez.booth.ui.fragments.DataSyncFragment;
import tschuba.ez.booth.ui.layouts.OneColumnLayout;
import tschuba.ez.booth.ui.layouts.app.AppLayoutWithMenu;
import tschuba.ez.booth.ui.resources.StreamResourceEvent;
import tschuba.ez.booth.ui.resources.StreamResourceFailedEvent;
import tschuba.ez.booth.ui.resources.StreamResourceHandler;
import tschuba.ez.booth.ui.resources.StreamResourceListener;
...
import static tschuba.ez.booth.ui.i18n.TranslationKeys.ExportImportView.*;
...
public class ExportImportView extends OneColumnLayout {
    ...
    public ExportImportView(@NonNull final EventService eventService,
        ...
        UploadI18N uploadI18N = tschuba.ez.booth.ui.i18n.Upload.upload(IMPORT_UPLOADER__I18N_PREFIX, getLocale());
